...
public class GameApp extends Game {
    private static final String UI_FONT_PATH = "fonts/AtkinsonHyperlegible-Regular.ttf";
    private static final int UI_FONT_SIZE = 28;
    ...
    private BitmapFont createUiFont() {
        FileHandle fontFile = Gdx.files.internal(UI_FONT_PATH);
        if (!fontFile.exists()) {
            BitmapFont fallbackFont = new BitmapFont();
            configureFontFiltering(fallbackFont);
            return fallbackFont;
        }
        ...
        try {
            ...
            configureFontFiltering(generatedFont);
